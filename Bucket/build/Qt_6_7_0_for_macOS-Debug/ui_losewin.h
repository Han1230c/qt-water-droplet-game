...
public:
    ...
    void setupUi(QDialog *loseWin)
    {
        ...
        labelTitle->setGeometry(QRect(80, 100, 231, 61));
        QFont font;
        font.setFamilies({QString::fromUtf8("Academy Engraved LET")});
        font.setPointSize(42);
        labelTitle->setFont(font);
        leaveBtm = new QPushButton(loseWin);
        leaveBtm->setObjectName("leaveBtm");
        leaveBtm->setGeometry(QRect(140, 180, 100, 32));
        QFont font1;
        font1.setPointSize(13);
        leaveBtm->setFont(font1);
    ...
    void retranslateUi(QDialog *loseWin)
    {
        ...
        leaveBtm->setText(QCoreApplication::translate("loseWin", "Leave", nullptr));
    } // retranslateUi
